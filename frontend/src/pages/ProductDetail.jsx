...
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-zinc-100 to-gray-200 dark:from-zinc-900 dark:to-black">
//         <p className="pt-20 text-center text-red-500 dark:text-red-400">{console.log(error)}</p>
//       </div>
//     );
//   }
...
//             {/* <p className="text-gray-700 dark:text-gray-300">{product.asin ? {"Amazon"} : {"Flipkart"}}</p> */}
...
//             }
//             {wishError && (
//               <p className="text-red-500 dark:text-red-400 text-sm">{console.log(wishError)}</p>
//             )}
//             {wishSuccess && (
      ...
      <main className="max-w-6xl mx-auto py-8">
        ...
        <section className="flex flex-col md:flex-row gap-8 bg-white dark:bg-zinc-800 p-6 rounded-lg shadow-lg" aria-labelledby="product-title">
          ...
          <div className="flex-1 space-y-4">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              {(product.source === "amazon" || product.asin) ? "Amazon" : "Flipkart"}
            </p>
            {product.description && (
              <p className="text-gray-700 dark:text-gray-300">{product.description}</p>
            )}
